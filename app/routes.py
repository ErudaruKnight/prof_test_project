...
from .career_utils import load_structure, calculate_interest_scores, recommend_program, ensure_career_test
...
def career_test():
    ...
    if request.method == 'POST':
        ...
        result_text = f'Рекомендуемое направление: {program}' if program else 'Не удалось определить направление.'
